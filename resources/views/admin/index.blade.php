            ...
            <div class="col-md-12">
                <div class="navbar-collapse collapse ">
                    <ul id="menu-top" class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="form.blade.php">FORMS</a></li>
                        <li>
                            <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown">UI ELEMENTS <i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="ui.blade.php">UI ELEMENTS</a></li>
                                <li role="presentation"><a role="menuitem" tabindex="-1" href="#">EXAMPLE LINK</a></li>
                            </ul>
                        </li>
                        <li><a href="tab.blade.php">TABS & PANELS</a></li>
                        <li><a href="table.blade.php">TABLES</a></li>
                ...
                <div class="panel panel-primary ">
                    ...
                    <div class="panel-body chat-widget-main">
                        ...
                        <div class="chat-widget-name-left">
                            <img class="media-object img-circle img-left-chat" src="{{asset("asset/img/user2.png")}}" />
                            <h4>  Amanna Seiar</h4>
                        ...
                        <div class="chat-widget-name-right">
                            <img class="media-object img-circle img-right-chat" src="{{asset("asset/img/user2.png")}}" />
                            <h4>  Amanna Seiar</h4>
                            <h5>Time 2:00 pm at 25th july</h5>
                        </div>
                        <hr />
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body text-center recent-users-sec">
                        <img class="img-thumbnail" src="{{asset("asset/img/user.gif")}}" />
                        <img class="img-thumbnail" src="{{asset("asset/img/user2.png")}}" />
                        <img class="img-thumbnail" src="{{asset("asset/img/user.gif")}}" />
                        <img class="img-thumbnail" src="{{asset("asset/img/user2.png")}}" />
                        <img class="img-thumbnail" src="{{asset("asset/img/user.gif")}}" />
                        <img class="img-thumbnail" src="{{asset("asset/img/user2.png")}}" />
                        ...
                        <ul class="media-list">
                            ...
                            <li class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object img-circle img-comments" src="{{asset("asset/img/user.gif")}}" />
                                </a>
                                <div class="media-body">
                                    ...
                                    <div class="media">
                                        <a class="pull-left" href="#">
                                            <img class="media-object img-circle img-comments" src="{{asset("asset/img/user2.png")}}">
                                        </a>
                                        <div class="media-body">
