    ...
    <div class="navbar navbar-inverse set-radius-zero" >
        <div class="container">
           ...
           <a href="{{route('welcome')}}"  >   ADMIN   </a>
            ...
            <div class="right-div">
                <a href="{{route('admin.logout')}}" class="btn btn-danger pull-right">LOG  OUT</a>
            </div>
        </div>
    </div>
    <!-- LOGO HEADER END-->
    ...
    <section class="footer-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    &copy; 2024 +37477889664 |<a href="http://www.binarytheme.com/" target="_blank"  > Designed by : sargsyanhar5@gmail.com</a>
                </div>
